...
// Define a Booking type for better type safety
type Booking = {
  id: number;
  guestName: string;
  checkIn: string;
  ...
  >
    <div className="text-gray-800 w-full md:w-auto space-y-2">
      ...
      <p className="flex items-center gap-2 text-gray-600">
        <FiCalendar className="text-gray-500" /> Check-in: {booking.checkIn}
      </p>
      <p className="flex items-center gap-2 text-gray-600">
      ...
      <p className="text-sm font-medium text-indigo-600">{booking.tourType}</p>
      <p className="flex items-center gap-2 text-gray-600">
